...
<html dir="ltr" lang="en">
  ...
  <head>
    ...
    <title>Welcome back to AbegHelp!</title>
  </head>
      ...
      <tbody>
        <tr style="width:100%">
          <td>
            ...
            <div style="display:none;overflow:hidden;line-height:1px;opacity:0;max-height:0;max-width:0">AbegHelp - We&#x27;re glad to have you back!
            </div>
            ...
            <h1 style="font-size:1.25rem;line-height:1.75rem;letter-spacing:0.025em;font-weight:700;text-align:center">Welcome Back to AbegHelp!</h1>
          <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation">
              <tbody>
                <tr>
            ...
            <table align="center" width="100%" border="0" cellPadding="0" cellSpacing="0" role="presentation">
              <tbody>
                <tr>
                  <td>
                    <p class="" style="font-size:1.25rem;line-height:1.75rem;margin:16px 0">Welcome back, ${data.name}</p>
                    <p style="font-size:14px;line-height:24px;margin:16px 0">We&#x27;re happy to inform you that your account has been successfully restored.</p>
                    <p style="font-size:14px;line-height:24px;margin:16px 0">You can now log in and continue using our services.</p><a style="color:rgb(255,255,255);text-decoration:none;background-color:rgb(43,144,142);padding-left:1.75rem;padding-right:1.75rem;padding-top:0.5rem;padding-bottom:0.5rem;margin-top:0.75rem;margin-bottom:0.75rem;border-radius:0.375rem;text-align:center;margin-left:auto;margin-right:auto;cursor:pointer" target="_blank" href=${data.loginLink}>Log in</a>
                  </td>
                </tr>
              </tbody>
            </table>
